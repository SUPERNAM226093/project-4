...
CREATE TABLE `lab_order_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_lab_order_items_order` (`lab_order_id`),
  KEY `fk_lab_order_items_service` (`service_id`),
...
INSERT INTO `lab_order_items` VALUES (1,1,NULL,'thận ',NULL,NULL),(2,2,NULL,'',NULL,NULL);
...
-- Dump completed on 2026-05-18 21:28:01
